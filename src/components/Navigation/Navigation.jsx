          ...
          <ul className='navigation__list'>
              <li className='navigation__item'>
                <NavLink
                  ...
                  to={!loggin ? '/signup' : '/movies'}
                  activeClassName='navigation__link navigation__link_active'
                  >
                    {!loggin ? 'Регистарация' : "Фильмы"}
                </NavLink>
              </li>
              <li className='navigation__item'>
                  <NavLink
                    to={!loggin ? '/signin' : '/saved-movies'}
                    className={loggin ? 'navigation__link' : 'navigation__link navigation__link_enter'}
                    >
                      {!loggin ? 'Войти' : "Сохранённые фильмы"}
                  </NavLink>
              </li>
              {loggin &&
                <li className='navigation__item'>
